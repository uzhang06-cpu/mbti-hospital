...
LIFE_EVENTS = {
    "ENFP": ["刚抢到了演唱会票！！！", "社团招新我们摊位今天爆满", "食堂新窗口的鸡排绝了",
...
FALLBACK_MOMENTS_CONTENT = {
    "ENFP": ["谁懂啊今天遇到个超离谱的事", "好想吃火锅有没有人约", "最近追的剧太上头了", "今天天气好适合翘课(不是)"],
...
# ── 角色兴趣关键词（触发更高参与度）────────────────────────────
INTEREST_TRIGGERS = {
    "ENFP": {"kws": ["奶茶", "探店", "追剧", "猫", "好玩", "打卡", "社团", "美食", "可爱"],       "boost": 0.35},
...
FORMAT_RULES = (
    ...
    "- 语气自然口语就行，别刻意堆语气词；尤其别动不动就「哈哈」「哈哈哈」——大多数话根本不用带笑，真觉得好笑才笑一下。可以不打标点、可以用省略号、可以有错别字、偶尔用 yyds/xswl 这种缩写。\n"
